          ...
          <div className="steps2-container3">
            <div className="steps2-container4 thq-card">
              <h2 className="thq-heading-2">
                {props.step1Title ?? (
                  <Fragment>
                    <span className="steps2-text29">Recognize the Issue</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text25">
                      Understand the impact of short attention spans on students
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text28">
                      Encourage students to practice time management skills to
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text26">
                      Organize offline events and activities to help students
                      engage in real-world interactions and reduce screen time.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text31">
                      Provide resources and information on maintaining a healthy
                      balance between online and offline activities for overall
                      well-being.
                    </span>
                  </Fragment>
                )}
